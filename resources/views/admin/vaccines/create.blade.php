...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Add New Vaccine</h1>
    </div>
    <div class="bg-white dark:bg-[#151c2c] rounded-2xl border border-slate-100 dark:border-slate-800/80 shadow-md p-8 animate-fade-in-up transition-colors duration-200">
        ...
        <form method="POST" action="{{ route('admin.vaccines.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex gap-3 mt-6">
                ...
                <button type="submit" class="flex-1 py-3 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-semibold rounded-xl text-sm transition-all duration-200 active:scale-98 hover:shadow-lg hover:shadow-blue-500/15">Add Vaccine</button>
            </div>
        </form>
    </div>
</div>
