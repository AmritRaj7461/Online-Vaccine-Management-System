...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-colors duration-200"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form method="POST" action="{{ route('user.profile.update') }}" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        {{-- Input + Status Row (stacked on mobile, side-by-side on sm+) --}}
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                            <div class="relative flex-1">
                                ...
                                <input type="text" name="aadhar_number" id="aadhar_number" required maxlength="12" x-model="aadhar" placeholder="Enter your 12-digit Aadhaar number"
                                       :readonly="isVerified"
                                       class="w-full pl-12 pr-4 py-2.5 bg-slate-50 dark:bg-[#0b0f19] border border-slate-200 dark:border-slate-800 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/50 transition-all text-sm"
                            ...
                            <template x-if="isVerified">
                                <span class="shrink-0 inline-flex items-center gap-1.5 bg-emerald-500/15 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider select-none w-full sm:w-auto justify-center">
                            ...
                            <template x-if="!isVerified && aadhar.length === 12">
                                <button type="button" @click="triggerVerification()"
                                        class="shrink-0 inline-flex items-center justify-center gap-1.5 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all active:scale-95 shadow-md shadow-blue-500/15 hover:shadow-blue-500/25 cursor-pointer w-full sm:w-auto">
        ...
        <div class="space-y-6">
            ...
            <div class="relative w-full h-[240px] max-w-sm mx-auto bg-gradient-to-br from-[#fcfbf7] via-[#f7fafd] to-[#f4faf7] dark:from-[#111726] dark:via-[#131b2f] dark:to-[#0f1524] border-2 border-amber-500/30 dark:border-amber-500/15 rounded-2xl shadow-xl flex flex-col justify-between overflow-hidden group select-none transition-all duration-300 hover:shadow-2xl">
